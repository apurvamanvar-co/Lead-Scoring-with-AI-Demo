# =============================================================================
# RevOps Lead Prioritization Prototype
# =============================================================================
...
# is a dict whose fields are grouped by the tool that would own them in a
# typical RevOps stack (HubSpot / Clay / Product). Data is deliberately
...
# and make demo requests rare — that's the core problem here: a flood of
...
#
# This is a small team — no territories. Every rep covers everything; we just
...
st.set_page_config(page_title="RevOps Lead Prioritization",
...
def _require_password():
    ...
    if not required or st.session_state.get("_authed"):
        return
    st.title("🎯 RevOps Lead Prioritization")
...
def render_route():
    ...
    st.markdown(
        ...
        "**C & D** go to marketing nurture. This is a small team with no territories — "
